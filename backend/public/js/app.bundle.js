...
/* harmony import */ var _component_sidebar_ExerciseTypesSidebar__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./component/sidebar/ExerciseTypesSidebar */ "./src/component/sidebar/ExerciseTypesSidebar.ts");
/* harmony import */ var _component_view_ExerciseTypesCompositeView__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./component/view/ExerciseTypesCompositeView */ "./src/component/view/ExerciseTypesCompositeView.ts");
/* harmony import */ var _component_sidebar_WorkoutSummarySidebar__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./component/sidebar/WorkoutSummarySidebar */ "./src/component/sidebar/WorkoutSummarySidebar.ts");
/* harmony import */ var _component_view_WorkoutSummaryView__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./component/view/WorkoutSummaryView */ "./src/component/view/WorkoutSummaryView.ts");
/* harmony import */ var _component_sidebar_CurrentWorkoutSidebar__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./component/sidebar/CurrentWorkoutSidebar */ "./src/component/sidebar/CurrentWorkoutSidebar.ts");
/* harmony import */ var _component_view_CurrentWorkoutCompositeView__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./component/view/CurrentWorkoutCompositeView */ "./src/component/view/CurrentWorkoutCompositeView.ts");
/* harmony import */ var _component_view_WorkoutsViewUsingContext__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./component/view/WorkoutsViewUsingContext */ "./src/component/view/WorkoutsViewUsingContext.ts");
...
class App {
  ...
  setupNavigationItemHandling() {
    // @ts-ignore
    document.getElementById(_AppTypes__WEBPACK_IMPORTED_MODULE_3__.NAVIGATION.userSearchId).addEventListener('click', this.handleShowUserSearch); // @ts-ignore

    document.getElementById(_AppTypes__WEBPACK_IMPORTED_MODULE_3__.NAVIGATION.exerciseTypesId).addEventListener('click', this.handleShowExerciseTypes); // @ts-ignore

    document.getElementById(_AppTypes__WEBPACK_IMPORTED_MODULE_3__.NAVIGATION.workoutSummary).addEventListener('click', this.handleShowWorkoutSummary); // @ts-ignore

    document.getElementById(_AppTypes__WEBPACK_IMPORTED_MODULE_3__.NAVIGATION.currentWorkout).addEventListener('click', this.handleShowCurrentWorkout); // @ts-ignore

    this.chatNavigationItem = document.getElementById(_AppTypes__WEBPACK_IMPORTED_MODULE_3__.NAVIGATION.chatId); // @ts-ignore
  ...
  setupUserSearchViews() {
    ...
    this.userSearchSidebar = ui_framework_jps__WEBPACK_IMPORTED_MODULE_0__.UserSearchSidebar.getInstance(_Controller__WEBPACK_IMPORTED_MODULE_2__["default"].getInstance().getStateManager());
    this.userSearchSidebar.onDocumentLoaded();
  }

  setupChatViews() {
    // add the views to the chat side bar
    this.chatSidebar = ui_framework_jps__WEBPACK_IMPORTED_MODULE_0__.ChatRoomsSidebar.getInstance(_Controller__WEBPACK_IMPORTED_MODULE_2__["default"].getInstance().getStateManager());
  ...
  onDocumentLoad() {
    ...
    this.exerciseTypesSidebar = new _component_sidebar_ExerciseTypesSidebar__WEBPACK_IMPORTED_MODULE_4__["default"]();
    new _component_view_ExerciseTypesCompositeView__WEBPACK_IMPORTED_MODULE_5__.ExerciseTypesCompositeView(this.exerciseTypesSidebar).onDocumentLoaded(); //new WorkoutsView().onDocumentLoaded(); // carousel view

    new _component_view_WorkoutsViewUsingContext__WEBPACK_IMPORTED_MODULE_10__.WorkoutsViewUsingContext().onDocumentLoaded();
    this.workoutSummarySidebar = new _component_sidebar_WorkoutSummarySidebar__WEBPACK_IMPORTED_MODULE_6__["default"]();
    this.workoutSummarySidebar.addView(new _component_view_WorkoutSummaryView__WEBPACK_IMPORTED_MODULE_7__.WorkoutSummaryView(), {
      containerId: _component_sidebar_WorkoutSummarySidebar__WEBPACK_IMPORTED_MODULE_6__["default"].SidebarContainers.container
    });
    this.workoutSummarySidebar.onDocumentLoaded();
    this.currentWorkoutSidebar = new _component_sidebar_CurrentWorkoutSidebar__WEBPACK_IMPORTED_MODULE_8__["default"]();
    this.currentWorkoutView = new _component_view_CurrentWorkoutCompositeView__WEBPACK_IMPORTED_MODULE_9__.CurrentWorkoutCompositeView(this.currentWorkoutSidebar);
  ...
  handleShowUserSearch(event) {
    ...
    if (!_Controller__WEBPACK_IMPORTED_MODULE_2__["default"].getInstance().isLoggedIn()) {
      // @ts-ignore
      window.location.href = _AppTypes__WEBPACK_IMPORTED_MODULE_3__.API_Config.login;
      return;
    }
  ...
  addingExerciseToCurrentWorkout(exerciseType) {
    ...
    this.currentWorkoutView.getStateManager().addNewItemToState(_AppTypes__WEBPACK_IMPORTED_MODULE_3__.STATE_NAMES.exerciseTypes, exerciseType, false);
  }
...
class Controller {
  ...
  setupDataObjectDefinitions() {
    ...
    ui_framework_jps__WEBPACK_IMPORTED_MODULE_3__.BasicObjectDefinitionFactory.getInstance().addStringFieldToObjDefinition(exerciseTypeDefinition, "name", "Name", ui_framework_jps__WEBPACK_IMPORTED_MODULE_3__.FieldType.text, true, "Exercise name");
    ...
    ui_framework_jps__WEBPACK_IMPORTED_MODULE_3__.BasicObjectDefinitionFactory.getInstance().addStringFieldToObjDefinition(exerciseTypeDefinition, "duration", "Duration", ui_framework_jps__WEBPACK_IMPORTED_MODULE_3__.FieldType.duration, true, "Exercise time");
    ui_framework_jps__WEBPACK_IMPORTED_MODULE_3__.BasicObjectDefinitionFactory.getInstance().addStringFieldToObjDefinition(exerciseTypeDefinition, "sets", "Sets", ui_framework_jps__WEBPACK_IMPORTED_MODULE_3__.FieldType.integer, false, "Number of sets");
    ui_framework_jps__WEBPACK_IMPORTED_MODULE_3__.BasicObjectDefinitionFactory.getInstance().addStringFieldToObjDefinition(exerciseTypeDefinition, "reps", "Repetitions", ui_framework_jps__WEBPACK_IMPORTED_MODULE_3__.FieldType.integer, false, "Number of reps");
    ui_framework_jps__WEBPACK_IMPORTED_MODULE_3__.BasicObjectDefinitionFactory.getInstance().addStringFieldToObjDefinition(exerciseTypeDefinition, "weight", "Weight", ui_framework_jps__WEBPACK_IMPORTED_MODULE_3__.FieldType.float, false, "Weight used");
    ui_framework_jps__WEBPACK_IMPORTED_MODULE_3__.BasicObjectDefinitionFactory.getInstance().addStringFieldToObjDefinition(exerciseTypeDefinition, "distance", "Distance", ui_framework_jps__WEBPACK_IMPORTED_MODULE_3__.FieldType.float, false, "Distance travelled");
    cLogger(`Exercise type data object definition`);
    cLogger(exerciseTypeDefinition);
    cLoggerDetail(ui_framework_jps__WEBPACK_IMPORTED_MODULE_3__.ObjectDefinitionRegistry.getInstance().findDefinition('exerciseType'));
    ...
    cLoggerDetail(ui_framework_jps__WEBPACK_IMPORTED_MODULE_3__.ObjectDefinitionRegistry.getInstance().findDefinition('workout'));
  }
  /*
...
class CurrentWorkoutCompositeView {
  ...
  onDocumentLoaded() {
    ...
    if (exerciseTypeDefinition) {
      let exerciseTypeDetailRenderer = new ui_framework_jps__WEBPACK_IMPORTED_MODULE_7__.FormDetailViewRenderer(_AppTypes__WEBPACK_IMPORTED_MODULE_0__.VIEW_CONTAINER.currentWorkoutDetail, exerciseTypeDefinition, new ui_framework_jps__WEBPACK_IMPORTED_MODULE_7__.DefaultFormFieldPermissionChecker(), ui_framework_jps__WEBPACK_IMPORTED_MODULE_7__.BootstrapFormConfigHelper.getInstance());
...
class CurrentWorkoutExercisesView extends ui_framework_jps__WEBPACK_IMPORTED_MODULE_3__.AbstractStatefulCollectionView {
  ...
  constructor(stateManager) {
    ...
    ui_framework_jps__WEBPACK_IMPORTED_MODULE_3__.ContextualInformationHelper.getInstance().addContextFromView(this, _AppTypes__WEBPACK_IMPORTED_MODULE_0__.STATE_NAMES.exerciseTypes, 'Exercise Types');
  }
...
/* harmony import */ var _sidebar_ExerciseTypesSidebar__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../sidebar/ExerciseTypesSidebar */ "./src/component/sidebar/ExerciseTypesSidebar.ts");
...
class ExerciseTypesCompositeView {
  ...
  onDocumentLoaded() {
    ...
    this.sideBar.addView(exerciseTypes, {
      containerId: _sidebar_ExerciseTypesSidebar__WEBPACK_IMPORTED_MODULE_7__["default"].SidebarContainers.container
    });
    const exerciseTypeDefinition = ui_framework_jps__WEBPACK_IMPORTED_MODULE_6__.ObjectDefinitionRegistry.getInstance().findDefinition(_AppTypes__WEBPACK_IMPORTED_MODULE_0__.STATE_NAMES.exerciseTypes);

    if (exerciseTypeDefinition) {
      let exerciseTypeDetailRenderer = new ui_framework_jps__WEBPACK_IMPORTED_MODULE_6__.FormDetailViewRenderer(_AppTypes__WEBPACK_IMPORTED_MODULE_0__.VIEW_CONTAINER.exerciseTypeDetail, exerciseTypeDefinition, new _CreatedByPermissionChecker__WEBPACK_IMPORTED_MODULE_5__.CreatedByPermissionChecker(), ui_framework_jps__WEBPACK_IMPORTED_MODULE_6__.BootstrapFormConfigHelper.getInstance());
      let exerciseTypeDetailView = new ui_framework_jps__WEBPACK_IMPORTED_MODULE_6__.DetailViewImplementation({
      ...
      let viewLinker = new ui_framework_jps__WEBPACK_IMPORTED_MODULE_6__.LinkedCollectionDetailController(_AppTypes__WEBPACK_IMPORTED_MODULE_0__.STATE_NAMES.exerciseTypes, exerciseTypes);
      viewLinker.addLinkedDetailView(exerciseTypeDetailView);
      this.sideBar.onDocumentLoaded();
      let startingDisplayOrder = ui_framework_jps__WEBPACK_IMPORTED_MODULE_6__.BasicObjectDefinitionFactory.getInstance().generateStartingDisplayOrder(exerciseTypeDefinition);
      exerciseTypeDetailView.initialise(startingDisplayOrder, false, true);
      const detailForm = exerciseTypeDetailRenderer.getForm();
