...
class Controller {
  ...
  */
  ...
  addExerciseToCurrentWorkout(exerciseType) {
    let copyOfExercise = (0,ui_framework_jps__WEBPACK_IMPORTED_MODULE_3__.copyObject)(exerciseType);
  ...
  setupDataObjectDefinitions() {
    ...
    let exercisesFieldDefinition = ui_framework_jps__WEBPACK_IMPORTED_MODULE_3__.BasicObjectDefinitionFactory.getInstance().addStringFieldToObjDefinition(workoutDefinition, "exercises", "Exercises", ui_framework_jps__WEBPACK_IMPORTED_MODULE_3__.FieldType.compositeObjectArray, true, "Exercises in this workout"); // exercisesFieldDefinition.idType = KeyType.collection;
              ...
              case _AppTypes__WEBPACK_IMPORTED_MODULE_2__.STATE_NAMES.users:
                {
                  ...
                  ui_framework_jps__WEBPACK_IMPORTED_MODULE_3__.NotificationManager.getInstance().show(stateObj.username, `${stateObj.username} has just registered.`, '1', ui_framework_jps__WEBPACK_IMPORTED_MODULE_3__.NotificationType.message);
                  break;
                }
...
/* harmony import */ var ui_framework_jps_dist_framework_model_DataObjectFactory__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ui-framework-jps/dist/framework/model/DataObjectFactory */ "./node_modules/ui-framework-jps/dist/framework/model/DataObjectFactory.js");
...
class CurrentWorkoutCompositeView {
  ...
  createWorkout() {
    ...
    const def = ui_framework_jps__WEBPACK_IMPORTED_MODULE_7__.ObjectDefinitionRegistry.getInstance().findDefinition(_AppTypes__WEBPACK_IMPORTED_MODULE_0__.STATE_NAMES.workouts);
    this.currentWorkout = ui_framework_jps_dist_framework_model_DataObjectFactory__WEBPACK_IMPORTED_MODULE_8__.DataObjectFactory.getInstance().instance(def).getData();
